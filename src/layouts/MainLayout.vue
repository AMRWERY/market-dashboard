<template>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="" class="flex ml-2 md:mr-24">
                        <img src="/shopping-bag-ecommerce-svgrepo-com.svg" class="h-8 mr-3" />
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Market
                            Dashboard</span>
                    </a>
                </div>
    ...
    <div class="p-4 sm:ms-64 mt-12">
        <div class="p-4 border-gray-200rounded-lg dark:border-gray-700">
            <RouterView />
        </div>
    </div>
</template>
